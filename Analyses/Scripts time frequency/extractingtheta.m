%We select the time window of interest from the graph of time-freq averaging high and low

%% Tabla trials media theta para mediacion
%The indexes of theta will also be used to correlate with decoding


%We select 3 to lower than 8hz frequency from the data
...
%after that we delete the rows with NaN values
