...
cfg.analysis = 'MVPA';
cfg.location = 'E:\Mi unidad\Experimento competition\DATA\EEG\Analisis multi\mvpa cue hi vs cue lo'; %Location to save the results
...
cfg.trialaver.flag     = true; %True meaning making supertrials
...
cfg.tm.tpstart   = -100; 
cfg.tm.tpend     = 1550; 
cfg.tm.tpsteps   = 3; %Every 3 timepoints the analysis is performed
