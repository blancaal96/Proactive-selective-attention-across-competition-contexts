...
if an == 1
    condition_a = 'cue_face_1_hi'; 
    condition_b = 'cue_name_1_hi';
    condition_c = 'cue_face_2_lo'; 
    condition_d = 'cue_name_2_lo'; 
else
    condition_a = 'cue_face_1_lo';
    condition_b = 'cue_name_1_lo';
    condition_c = 'cue_face_2_hi';
    condition_d = 'cue_name_2_hi';
end
...
% cfg.study.dataPaths{1,1} = ['E:\Mi unidad\Experimento Competition\DATA\EEG\conditions3mat\cues clasificadas\' condition_a '\'] ; %[ ]
% cfg.study.dataPaths{1,2} = ['E:\Mi unidad\Experimento Competition\DATA\EEG\conditions3mat\cues clasificadas\' condition_b '\'];
% cfg.study.dataPaths{2,1} = ['E:\Mi unidad\Experimento Competition\DATA\EEG\conditions3mat\cues clasificadas\' condition_c '\'] ; %[ ]
% cfg.study.dataPaths{2,2} = ['E:\Mi unidad\Experimento Competition\DATA\EEG\conditions3mat\cues clasificadas\' condition_d '\'];
% 
% % Data files:
% for d = 1: 36
